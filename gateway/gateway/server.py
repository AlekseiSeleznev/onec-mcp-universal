...
_REPORT_API_ACTIONS = {
    ...
    "runner-policy": "get_report_runner_policy",
    "set-runner-policy": "set_report_runner_policy",
    "ui-strategy": "get_report_ui_strategy",
    "set-ui-strategy": "set_report_ui_strategy",
    "run": "run_report",
...
def _collect_diagnostics() -> dict:
    ...
    diag = {
        ...
        "config": {
            ...
            "REPORT_UI_RUNNER_URL": settings.report_ui_runner_url,
            "TEST_RUNNER_URL": settings.test_runner_url,
            "BSL_GRAPH_URL": settings.bsl_graph_url,
        },
    }
