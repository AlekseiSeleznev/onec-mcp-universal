...
```powershell
python .claude/skills/web-unpublish/scripts/web-unpublish.py <параметры>
```
...
python .claude/skills/web-unpublish/scripts/web-unpublish.py -AppName "bpdemo"

# Удалить все публикации
python .claude/skills/web-unpublish/scripts/web-unpublish.py -All

# С указанием пути
python .claude/skills/web-unpublish/scripts/web-unpublish.py -AppName "mydb" -ApachePath "C:\tools\apache24"
```
