...
```powershell
python skills/web-unpublish/scripts/web-unpublish.py <параметры>
```
...
python skills/web-unpublish/scripts/web-unpublish.py -AppName "bpdemo"

# Удалить все публикации
python skills/web-unpublish/scripts/web-unpublish.py -All

# С указанием пути
python skills/web-unpublish/scripts/web-unpublish.py -AppName "mydb" -ApachePath "C:\tools\apache24"
```
