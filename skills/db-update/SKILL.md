...
```powershell
python .claude/skills/db-update/scripts/db-update.py <параметры>
```
...
python .claude/skills/db-update/scripts/db-update.py -InfoBasePath "C:\Bases\MyDB" -UserName "Admin"

# Динамическое обновление (серверная база)
python .claude/skills/db-update/scripts/db-update.py -InfoBaseServer "srv01" -InfoBaseRef "MyDB" -UserName "Admin" -Password "secret" -Dynamic "+"

# Обновление расширения
python .claude/skills/db-update/scripts/db-update.py -InfoBasePath "C:\Bases\MyDB" -UserName "Admin" -Extension "МоёРасширение"
```
