...
```powershell
python skills/epf-validate/scripts/epf-validate.py -ObjectPath "src/МояОбработка"
python skills/epf-validate/scripts/epf-validate.py -ObjectPath "src/МояОбработка/МояОбработка.xml"
```
