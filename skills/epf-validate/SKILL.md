...
```powershell
python .claude/skills/epf-validate/scripts/epf-validate.py -ObjectPath "src/МояОбработка"
python .claude/skills/epf-validate/scripts/epf-validate.py -ObjectPath "src/МояОбработка/МояОбработка.xml"
```
