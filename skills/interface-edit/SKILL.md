...
```powershell
python 'skills/interface-edit/scripts/interface-edit.py' -CIPath '<path>' -Operation hide -Value '<cmd>'
```

### JSON mode

```powershell
python 'skills/interface-edit/scripts/interface-edit.py' -CIPath '<path>' -DefinitionFile '<json>'
```
