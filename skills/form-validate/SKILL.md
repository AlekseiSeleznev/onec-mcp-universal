...
```powershell
python skills/form-validate/scripts/form-validate.py -FormPath "Catalogs/Номенклатура/Forms/ФормаЭлемента"
python skills/form-validate/scripts/form-validate.py -FormPath "src/МояОбработка/Forms/Форма/Ext/Form.xml"
```
