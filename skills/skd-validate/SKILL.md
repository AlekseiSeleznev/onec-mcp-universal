...
```powershell
python skills/skd-validate/scripts/skd-validate.py -TemplatePath "src/МойОтчёт/Templates/ОсновнаяСхема"
python skills/skd-validate/scripts/skd-validate.py -TemplatePath "Catalogs/Номенклатура/Templates/СКД/Ext/Template.xml"
```
