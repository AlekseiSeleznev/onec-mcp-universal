...
```powershell
python .claude/skills/web-info/scripts/web-info.py <параметры>
```
...
```powershell
# Статус по умолчанию
python .claude/skills/web-info/scripts/web-info.py

# Указать путь к Apache
python .claude/skills/web-info/scripts/web-info.py -ApachePath "C:\tools\apache24"
```
