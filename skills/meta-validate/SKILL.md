...
```powershell
python skills/meta-validate/scripts/meta-validate.py -ObjectPath "Catalogs/Номенклатура/Номенклатура.xml"
python skills/meta-validate/scripts/meta-validate.py -ObjectPath "Catalogs/Банки|Documents/Заказ"
```
