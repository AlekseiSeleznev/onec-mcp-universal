...
```powershell
python .claude/skills/meta-validate/scripts/meta-validate.py -ObjectPath "Catalogs/Номенклатура/Номенклатура.xml"
python .claude/skills/meta-validate/scripts/meta-validate.py -ObjectPath "Catalogs/Банки|Documents/Заказ"
```
