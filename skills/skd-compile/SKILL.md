...
```powershell
# Из файла
python .claude/skills/skd-compile/scripts/skd-compile.py -DefinitionFile "<json>" -OutputPath "<Template.xml>"

# Из строки (без промежуточного файла)
python .claude/skills/skd-compile/scripts/skd-compile.py -Value '<json-string>' -OutputPath "<Template.xml>"
```
