...
```powershell
python .claude/skills/web-stop/scripts/web-stop.py <параметры>
```
...
```powershell
# Остановить Apache
python .claude/skills/web-stop/scripts/web-stop.py

# С указанием пути
python .claude/skills/web-stop/scripts/web-stop.py -ApachePath "C:\tools\apache24"
```
