...
```powershell
python skills/cf-validate/scripts/cf-validate.py -ConfigPath "upload/cfempty"
python skills/cf-validate/scripts/cf-validate.py -ConfigPath "upload/cfempty/Configuration.xml"
```
