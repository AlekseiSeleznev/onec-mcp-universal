...
```powershell
python skills/cfe-validate/scripts/cfe-validate.py -ExtensionPath "src"
python skills/cfe-validate/scripts/cfe-validate.py -ExtensionPath "src/Configuration.xml"
```
