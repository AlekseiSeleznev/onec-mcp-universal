...
```powershell
python .claude/skills/cfe-validate/scripts/cfe-validate.py -ExtensionPath "src"
python .claude/skills/cfe-validate/scripts/cfe-validate.py -ExtensionPath "src/Configuration.xml"
```
