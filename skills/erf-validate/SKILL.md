...
```powershell
python skills/epf-validate/scripts/epf-validate.py -ObjectPath "src/МойОтчёт"
python skills/epf-validate/scripts/epf-validate.py -ObjectPath "src/МойОтчёт/МойОтчёт.xml"
```
