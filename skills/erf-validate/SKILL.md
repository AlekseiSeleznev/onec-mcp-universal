...
```powershell
python .claude/skills/epf-validate/scripts/epf-validate.py -ObjectPath "src/МойОтчёт"
python .claude/skills/epf-validate/scripts/epf-validate.py -ObjectPath "src/МойОтчёт/МойОтчёт.xml"
```
