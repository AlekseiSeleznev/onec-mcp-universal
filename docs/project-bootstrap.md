...
`/1c-project-init` — это локальный помощник инициализации для проектов, которые хотят работать через `onec-mcp-universal` по каноническому рабочему процессу.
...
- минимальной локальной заготовки под процессный слой;
...
- `onec-universal` как основной MCP-адрес;
...
- нужно быстро выровнять локальную структуру проекта под процессный слой;
