...
- [Политика Git-артефактов и авторства](#политика-git-артефактов-и-авторства)
...
## Политика Git-артефактов и авторства

- EPF-бинарники не хранятся в git как рабочие артефакты.
- Исключение: `1c/MCPToolkit/build/MCPToolkit.epf` (канонический дистрибутив обработки, используемый в инструкциях).
- Для новых коммитов использовать только identity владельца (`AlekseiSeleznev`) без `Co-authored-by` и без bot-авторства.
