...
- [Подключение базы 1С](#подключение-базы-1с)
  ...
  - [Способ 2. Из Web UI дашборда](#способ-2-из-web-ui-дашборда)
...
- [Скилы 1С для Codex и совместимых локальных skill-runner'ов](#скилы-1с-для-codex-и-совместимых-локальных-skill-runnerов)
...
План интеграции пользовательского слоя и workflow-слоя поверх текущей технической базы описан в документе:
